...
class TemplateNameParserTest extends TestCase
{
    ...
    public function parseProvider()
    {
        return [
            ...
            ['FooBundle:Post:location_index.html.twig', 'FooBundle:Post:location_index.html.twig', '@FooBundle/Resources/views/Post/location_index.html.twig', new TemplateReference('FooBundle', 'Post', 'index', 'html', 'twig')],
