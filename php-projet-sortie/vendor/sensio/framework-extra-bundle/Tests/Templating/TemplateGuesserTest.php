...
class TemplateGuesserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGuessTemplateName()
    {
        ...
        $this->assertEquals('@Foo/foo/location_index.html.twig', (string) $templateReference);
    }
    ...
    public function testGuessTemplateWithoutBundle()
    {
        ...
        $this->assertEquals('my_admin/out_of_bundle/location_index.html.twig', (string) $templateReference);
    }
